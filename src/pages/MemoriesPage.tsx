  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="flex justify-between items-center mb-8">
        <h1 className="text-3xl font-bold text-echo-coffee dark:text-echo-cyber-neon">Soulbound Memories</h1>
      ...
      {nfts.length === 0 && (
        <div className="text-center py-12">
          <h3 className="text-xl text-echo-coffee/80 dark:text-echo-cyber-neon/80 mb-4">No Memory NFTs found</h3>
          <p className="text-echo-coffee/60 dark:text-echo-cyber-neon/60">Create your first Soulbound Memory NFT to preserve your personal memories.</p>
        </div>
      )}
    </div>
  );
