...
contract ProofOfGoodNFT is ERC721, Ownable, INFT {
    using Counters for Counters.Counter;
    Counters.Counter private _tokenIds;
    
    mapping(uint256 => NFTData) private _nftData;

    constructor() ERC721("Proof of Good NFT", "POG") Ownable() {}
    ...
    function getNFT(uint256 tokenId) external view override returns (NFTData memory) {
        require(_exists(tokenId), "ProofOfGoodNFT: NFT does not exist");
